...
(function () {
  ...
  $('btn-dec').addEventListener('click', function () {
    ...
    } catch (e) { $('t-result').className = 'out-body err'; $('t-result').textContent = 'Invalid encoded URL: ' + e.message; window.SVFeedback && window.SVFeedback.reportError(e.message, {"Input": ($('t-input').value || '').substring(0, 2000)}); }
  });
